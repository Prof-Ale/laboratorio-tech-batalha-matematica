...
export const trilha3 = [
    ...
    {
        id: "T3Q31", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Multiplicação de Inteiros",
        display: "(−6) × (−6) = ?",
        botoes: ["36", "−36", "12", "−12"], res: "36",
        passo: "Sinais iguais: resultado positivo. 6×6 = 36.",
        dica: "Negativo × Negativo = Positivo."
    },
    {
        id: "T3Q32", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Regra de Sinais",
        display: "Qual é o sinal do produto de três números negativos?",
        botoes: ["Negativo", "Positivo", "Depende dos números", "Sempre zero"], res: "Negativo",
        passo: "Três negativos: (−)×(−) = (+), depois (+)×(−) = (−). Número ímpar de negativos sempre dá negativo.",
        dica: "Número ímpar de fatores negativos → resultado negativo."
    },
    {
        id: "T3Q33", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Divisão de Inteiros",
        display: "(−56) ÷ 8 = ?",
        botoes: ["−7", "7", "−48", "48"], res: "−7",
        passo: "56 ÷ 8 = 7. Sinais diferentes: resultado negativo. Resposta: −7.",
        dica: "Sinais diferentes na divisão: resultado negativo."
    },
    {
        id: "T3Q34", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Expressão com Inteiros",
        display: "(−4) × 3 + (−2) × (−5) = ?",
        botoes: ["−2", "2", "−22", "22"], res: "−2",
        passo: "(−4)×3 = −12. (−2)×(−5) = +10. −12+10 = −2.",
        dica: "Calcule cada multiplicação primeiro, depois some os resultados."
    },
    {
        id: "T3Q35", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Potenciação de Inteiros",
        display: "(−2)⁵ = ?",
        botoes: ["−32", "32", "−10", "10"], res: "−32",
        passo: "5 fatores de −2. Expoente ímpar → negativo. 2⁵ = 32. Logo: −32.",
        dica: "Expoente ímpar com base negativa: resultado negativo."
    },
    {
        id: "T3Q36", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Multiplicação de Inteiros",
        display: "Um jogador perde 15 pontos por rodada. Após 6 rodadas, qual é a variação total de pontos?",
        botoes: ["−90", "90", "−21", "21"], res: "−90",
        passo: "(−15) × 6 = −90. Perdeu 90 pontos no total.",
        dica: "Perda é negativo; número de rodadas é positivo."
    },
    {
        id: "T3Q37", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Divisão de Inteiros",
        display: "(−144) ÷ (−12) = ?",
        botoes: ["12", "−12", "132", "−132"], res: "12",
        passo: "144 ÷ 12 = 12. Sinais iguais: resultado positivo.",
        dica: "Negativo ÷ Negativo = Positivo."
    },
    {
        id: "T3Q38", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Expressão com Inteiros",
        display: "[(−3) × (−4)] ÷ (−6) = ?",
        botoes: ["−2", "2", "−72", "72"], res: "−2",
        passo: "(−3)×(−4) = 12. 12 ÷ (−6) = −2.",
        dica: "Resolva o colchete primeiro, depois divida."
    },
    {
        id: "T3Q39", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Multiplicação de Inteiros",
        display: "Qual é o sinal de (−1)¹⁰⁰?",
        botoes: ["Positivo, pois 100 é par", "Negativo, pois a base é −1", "Zero", "Depende"], res: "Positivo, pois 100 é par",
        passo: "(−1)¹⁰⁰ = 1. Expoente par com base negativa sempre dá resultado positivo.",
        dica: "Expoente par → positivo. Expoente ímpar → negativo."
    },
    {
        id: "T3Q40", t: 3, tipo: "aritmetica", bncc: "EF07MA04", bncc_desc: "Divisão de Inteiros",
        display: "A temperatura de uma geladeira cai 3°C por hora. Após 8 horas, qual foi a variação total?",
        botoes: ["−24°C", "24°C", "−11°C", "11°C"], res: "−24°C",
        passo: "(−3) × 8 = −24°C. Queda de 24 graus no total.",
        dica: "Queda de temperatura é variação negativa."
    }
];
