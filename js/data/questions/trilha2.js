...
export const trilha2 = [
    ...
    {
        id: "T2Q31", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "Múltiplos",
        display: "Quais são os múltiplos de 7 entre 1 e 50?",
        botoes: ["7, 14, 21, 28, 35, 42, 49", "7, 14, 21, 28, 35, 42", "7, 14, 28, 35, 49", "14, 21, 28, 42, 49"], res: "7, 14, 21, 28, 35, 42, 49",
        passo: "Multiplique 7 por 1, 2, 3... até passar de 50: 7×7=49 ainda entra.",
        dica: "Múltiplos de 7: 7×1, 7×2, 7×3..."
    },
    {
        id: "T2Q32", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "Divisores",
        display: "Quantos divisores tem o número 36?",
        botoes: ["9", "6", "8", "12"], res: "9",
        passo: "Divisores de 36: 1, 2, 3, 4, 6, 9, 12, 18, 36. São 9 divisores.",
        dica: "36 = 2²×3². Pelo fórmula: (2+1)×(2+1) = 9 divisores."
    },
    {
        id: "T2Q33", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "MMC",
        display: "Dois alunos treinam atletismo. Um descansa a cada 4 dias, o outro a cada 6 dias. Descansaram juntos hoje. Em quantos dias descansarão juntos de novo?",
        botoes: ["12 dias", "24 dias", "2 dias", "10 dias"], res: "12 dias",
        passo: "MMC(4,6) = 12. Descansarão juntos novamente em 12 dias.",
        dica: "Encontro periódico: use o MMC."
    },
    {
        id: "T2Q34", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "MDC",
        display: "Um professor quer dividir 48 lápis de cor e 60 folhas em kits iguais, sem sobrar nada. Qual o maior número de kits possível?",
        botoes: ["12", "6", "4", "24"], res: "12",
        passo: "MDC(48,60) = 12. Pode fazer 12 kits com 4 lápis e 5 folhas cada.",
        dica: "Distribuição sem sobra em kits iguais: MDC."
    },
    {
        id: "T2Q35", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "Critérios de Divisibilidade",
        display: "O número 5.472 é divisível por 4?",
        botoes: ["Sim", "Não", "Só por 2", "Impossível saber"], res: "Sim",
        passo: "Critério do 4: olhe os dois últimos dígitos. 72 ÷ 4 = 18. Exato! Logo sim.",
        dica: "Para o 4: verifique apenas os dois últimos algarismos."
    },
    {
        id: "T2Q36", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "MMC",
        display: "Três semáforos abrem juntos. O primeiro abre a cada 30s, o segundo a cada 45s, o terceiro a cada 60s. Em quantos segundos abrirão juntos de novo?",
        botoes: ["180 s", "90 s", "135 s", "60 s"], res: "180 s",
        passo: "MMC(30,45,60) = 180 segundos = 3 minutos.",
        dica: "MMC dos três períodos."
    },
    {
        id: "T2Q37", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "Fatoração",
        display: "Qual é a decomposição em fatores primos de 60?",
        botoes: ["2² × 3 × 5", "2 × 3 × 5", "2³ × 5", "2 × 30"], res: "2² × 3 × 5",
        passo: "60 ÷ 2 = 30. 30 ÷ 2 = 15. 15 ÷ 3 = 5. 5 é primo. Logo: 2²×3×5.",
        dica: "Divida sempre pelo menor primo possível."
    },
    {
        id: "T2Q38", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "MDC",
        display: "Qual é o MDC de 100 e 75?",
        botoes: ["25", "5", "50", "15"], res: "25",
        passo: "100 = 2²×5². 75 = 3×5². MDC = 5² = 25.",
        dica: "Pegue os fatores comuns com o menor expoente."
    },
    {
        id: "T2Q39", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "Divisibilidade",
        display: "O número 1.332 é divisível por 9?",
        botoes: ["Sim", "Não", "Só por 3", "Depende"], res: "Sim",
        passo: "1+3+3+2 = 9. Soma divisível por 9: o número também é.",
        dica: "Some todos os algarismos. Divisível por 9 se a soma for múltiplo de 9."
    },
    {
        id: "T2Q40", t: 2, tipo: "aritmetica", bncc: "EF07MA01", bncc_desc: "MMC e MDC",
        display: "O MMC de dois números é 36 e o MDC é 6. Um deles é 12. Qual é o outro?",
        botoes: ["18", "24", "6", "36"], res: "18",
        passo: "MMC × MDC = produto dos números. 36×6 = 216. 216 ÷ 12 = 18.",
        dica: "Use a relação: MMC × MDC = a × b."
    }
];
