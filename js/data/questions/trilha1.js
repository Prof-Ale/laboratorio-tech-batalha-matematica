...
export const trilha1 = [
    ...
    {
        id: "T1Q31", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Inteiros em Contexto",
        display: "Um elevador está no 3º andar. Desce 7 andares. Em que andar está?",
        botoes: ["−4", "4", "−10", "10"], res: "−4",
        passo: "3 − 7 = −4. O quarto andar negativo significa subterrâneo 4.",
        dica: "Descer é subtrair; andar negativo é abaixo do térreo."
    },
    {
        id: "T1Q32", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Inteiros em Contexto",
        display: "A temperatura era −8°C e subiu 13°C. Qual a temperatura final?",
        botoes: ["5°C", "−5°C", "21°C", "−21°C"], res: "5°C",
        passo: "−8 + 13 = 5°C.",
        dica: "Subir temperatura é adicionar graus."
    },
    {
        id: "T1Q33", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Inteiros em Contexto",
        display: "Um mergulhador está a −30 m. Sobe 18 m. Qual sua profundidade agora?",
        botoes: ["−12 m", "12 m", "−48 m", "48 m"], res: "−12 m",
        passo: "−30 + 18 = −12 m. Ainda abaixo da superfície.",
        dica: "Subir diminui o valor negativo da profundidade."
    },
    {
        id: "T1Q34", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Adição e Subtração",
        display: "(−4) + (−9) + 3 = ?",
        botoes: ["−10", "10", "−16", "16"], res: "−10",
        passo: "(−4)+(−9) = −13. −13+3 = −10.",
        dica: "Some primeiro os negativos, depois combine com o positivo."
    },
    {
        id: "T1Q35", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Adição e Subtração",
        display: "15 − (−6) = ?",
        botoes: ["21", "9", "−21", "−9"], res: "21",
        passo: "Menos com menos vira mais: 15 + 6 = 21.",
        dica: "Subtrair um negativo é o mesmo que somar o positivo."
    },
    {
        id: "T1Q36", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Ordenação de Inteiros",
        display: "Ordene do MENOR ao MAIOR: −3, 0, −7, 2, −1",
        botoes: ["−7 < −3 < −1 < 0 < 2", "−3 < −7 < 0 < −1 < 2", "0 < −1 < 2 < −3 < −7", "2 > 0 > −1 > −3 > −7"], res: "−7 < −3 < −1 < 0 < 2",
        passo: "Na reta numérica, mais à esquerda é menor. Ordem: −7, −3, −1, 0, 2.",
        dica: "Quanto mais negativo, menor o número."
    },
    {
        id: "T1Q37", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Valor Absoluto",
        display: "Qual é o valor absoluto de −23?",
        botoes: ["23", "−23", "0", "1/23"], res: "23",
        passo: "|−23| = 23. Valor absoluto é sempre a distância ao zero, sem sinal.",
        dica: "Distância nunca é negativa."
    },
    {
        id: "T1Q38", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Inteiros em Contexto",
        display: "Uma empresa teve lucro de R$500 em jan, prejuízo de R$800 em fev e lucro de R$200 em mar. Qual o resultado final?",
        botoes: ["−R$100", "R$100", "−R$300", "R$1500"], res: "−R$100",
        passo: "500 − 800 + 200 = −100. Prejuízo de R$100.",
        dica: "Lucro é positivo, prejuízo é negativo."
    },
    {
        id: "T1Q39", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Adição e Subtração",
        display: "(−12) − (−5) + (−3) = ?",
        botoes: ["−10", "10", "−20", "4"], res: "−10",
        passo: "−12−(−5) = −12+5 = −7. Depois: −7+(−3) = −10.",
        dica: "Resolva da esquerda para a direita, tratando cada sinal com cuidado."
    },
    {
        id: "T1Q40", t: 1, tipo: "aritmetica", bncc: "EF07MA03", bncc_desc: "Inteiros em Contexto",
        display: "Malba Tahan tinha 200 moedas. Gastou 350 e recebeu 80. Qual o saldo?",
        botoes: ["−70", "70", "−270", "530"], res: "−70",
        passo: "200 − 350 + 80 = −70. Ficou devendo 70 moedas.",
        dica: "Some tudo com os sinais corretos: receber é +, gastar é −."
    }
];
